			...
			<div class="layui-col-md12">
				<form class="layui-form" action="">
					...
					<fieldset class="layui-elem-field">
							<label style="color: #fff">视频教学时间</label>	
							<div class="layui-col-md12">
								<ul id="daiban">
								</ul>
							</div>
...
layui.config({
    base : "../js/"
        		...
        		if(videoList!=null){
	        		for(var i=0;i<videoList.length;i++){
						...
						if((year + "-" + month+ "-" + day)==riqi){
							html+= "<li class='daibanTime' voide_key='"+videoList[i].videoKey+"'>"+hour + ":" + min + ":" + sec+"</li>"
						}
	                }
        		}
        		//清空该日的待办，增加该日的待办
		...
		form.on('submit(demo1)', function(data){
			...
			data.field.videoKey = videoKey;
			if(videoKey==undefined){
				common.cmsLayErrorMsg("请选择要分享的视频教学日程");
				return false;
			}
			$.ajax({
			       url : 'getSaveShareVideo.do',
			       type : 'post',
