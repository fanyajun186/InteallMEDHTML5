		...
		<div class="layui-col-md12 ">
			<form class="layui-form">
				<div class="layui-form-item" style="margin-top: 10px">
					<label class="layui-form-label">编辑收藏夹</label>
					<div class="layui-input-inline">
						<input type="text" id="collectionName" name="collectionName"  lay-verify="required"  class="layui-input" />
						<input type="hidden" id="collectionKey" name="collectionKey"   class="layui-input" />
					</div>
				</div>
...
$("#collectionName").val("${collection.collection_name}");
$("#collectionKey").val("${collection.collection_key}");
layui.config({
    base : "../js/"
