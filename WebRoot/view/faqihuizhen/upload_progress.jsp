                ...
                <table class="layui-table"  id="filelist" style="table-layout:fixed">
                    <thead>
                        <tr>
                            ...
                            <th width="100px" style="color:white">上传状态</th>
                        </tr>
                    </thead>
...
$(function(){
    ...
    $('#fileupload').bind('fileuploadsubmit', function (e, data) {
        data.formData = { "random": random};  //如果需要额外添加参数可以在这里添加
    });
    $("#fileupload").fileupload({
        ...
        add: function(e, data) { //add表示在选择文件时判断格式是否正确
            ...
            var html = ""
                ...
                html+='<td width="100px" style="color:white" id="'+random+'">等待上传</td>'
                html+='</tr>'
            ...
            if(data.result.code==0){
            	...
            	$('#'+data.result.random).html("<span style='color:red'>"+data.result.msg+"<span>");
            }else{
