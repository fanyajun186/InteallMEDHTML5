			...
			<form class="layui-form">
				<div class="layui-form-item" style="margin-top: 10px">
					...
					<div class="layui-input-inline">
						<input class="layui-input" name="name" value="${reportType.name}">
						<input type="hidden" id="reportTypeKey" name="reportTypeKey" value="${reportType.reportTypeKey}"  class="layui-input" />
					</div>
				</div>
