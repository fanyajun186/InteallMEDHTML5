...
<form class="layui-form" style="margin-top: 10px" action="">
    <div class="layui-form-item">
    	<input type="text" id="noticeId" name="noticeId" hidden="hidden" value="${notice.noticeid}">
		...
		<div class="layui-input-block">
		    ...
		    lay-verify="required" autocomplete="off" class="layui-input" value="${notice.noticename}">
		</div>
    </div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<textarea name="noticeContent" id="noticeContent" onkeyup="checkLen(this)" maxlength="100"
			 onpropertychange="if(value.length>100) value=value.substr(0,100)" class="layui-textarea layui-input" style="height: 300px">${notice.noticecontent}</textarea>
...
layui.config({
    ...
    form.on('submit(demo1)', function(data){
        ...
        $.ajax({
            ...
            type : 'post',
            async: false,
            data : {"noticeId":$("#noticeId").val(),"noticeName":$("#noticeName").val(),"noticeContent":$("#noticeContent").val()},
