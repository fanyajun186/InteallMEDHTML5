    ...
    <div class="layui-form-item">
	    <div class="layui-inline">
	        ...
	        <div class="layui-input-block">
                <input type="hidden" name="committeeimage" value="${cIntroduction.committeeimage }" />
                <input type="hidden" name="committeeid" value="${cIntroduction.committeeid }"  />
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
			...
			<div class="layui-input-block">
			    ...
			    lay-verify="required" autocomplete="off" class="layui-input" value="${cIntroduction.committeename }">
			</div>
		</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea id="committeeintroduction" lay-verify="required" name="committeeintroduction" placeholder="委员介绍"
                class="layui-textarea layui-input">${cIntroduction.committeeintroduction }</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea id="committeegoodat" lay-verify="required" name="committeegoodat" placeholder="擅长领域"
                class="layui-textarea layui-input">${cIntroduction.committeegoodat }</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" style="width: 100px">是否展示</label>
        <div class="layui-input-block">
	      <input name="isshow" title="是" type="radio" value="1">
...
layui.config({
    ...
    ,common = layui.common;
    var isshow = "${cIntroduction.isshow}";
    $("input:radio[name='isshow'][value="+isshow+"]").attr("checked",'checked');
    form.render("radio")
    $("#fileBtn").fileupload({
        url: 'uploadImage.do',
