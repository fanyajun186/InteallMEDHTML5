...
<form class="layui-form" action="" style="margin-top: 10px">
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        ...
        <input type="text" name="sysHospitalKey" id="sysHospitalKey" hidden="true">
      </div>
    </div>
    <div class="layui-inline">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	      <input type="radio" name="isCenter" value="0" title="是" checked="">
	      <input type="radio" name="isCenter" value="1" title="否">
	    </div>
	</div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 514px">
      <textarea name="hospAbout" id="hospAbout" placeholder="医院介绍" class="layui-textarea layui-input"></textarea>
    </div>
  </div>
  
  <div class="layui-form-item">
    <div class="layui-input-block">
      <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="demo1">编辑</button>
...
<script>
var sysHospital= ${sysHospital};
var defaults = {
    s1: 'hospAddPr',
    s2: 'hospAddCy',
    s3: 'hospAddQx',
    v1: sysHospital.hospAddPr,
    v2: sysHospital.hospAddCy,
    v3: sysHospital.hospAddQx
};

$(function(){
	
	$("#sysHospitalKey").val(sysHospital.sysHospitalKey);
	$("#hospName").val(sysHospital.hospName);
	$("#hospAbout").val(sysHospital.hospAbout);
	$("#hospSname").val(sysHospital.hospSname);
	$("#hospClass").val(sysHospital.hospClass);
	$("#hospLevel").val(sysHospital.hospLevel);
	$("#hospAdd").val(sysHospital.hospAdd);
	$("#hospPostCode").val(sysHospital.hospPostCode);
	$("#hospUser").val(sysHospital.hospUser);
	$("#hospTel").val(sysHospital.hospTel);
	$("#hospMobile").val(sysHospital.hospMobile);
	$("input:radio[name='isCenter']").eq(sysHospital.isCenter).attr("checked",'checked');
	$("#hospEmail").val(sysHospital.hospEmail);
})
...
layui.config({
  ...
  form.on('submit(demo1)', function(data){
	  data.field.sysHospitalKey = sysHospital.sysHospitalKey
