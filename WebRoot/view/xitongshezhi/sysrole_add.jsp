  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="roleName" id="roleName"  maxlength="30"  placeholder="角色名称"  lay-verify="required|roleName" autocomplete="off" class="layui-input">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
...
$(function(){
	...
	$.ajax({
		...
		success:function(data){
			var json = eval("("+data+")");
			var ztree = $.fn.zTree.init($("#treeRight"), setting, json.sysRightList);
...
layui.config({
  ...
  form.on('submit(demo1)', function(data){
      ...
      $.ajax({
          ...
          type : 'post',
          async: false,
          data : {"roleName":$("#roleName").val(),"rights":JSON.stringify(rights)},
          success : function(data) {
        	  data = eval("("+data+")");
              if(data.code == 0){
