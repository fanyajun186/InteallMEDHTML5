		...
		<div class="layui-col-md12 ">
			<form class="layui-form" action="">
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea name="yuhuirenyuan" id="yuhuirenyuan" placeholder="与会人员" lay-verify="required" class="layui-textarea layui-input"></textarea>
					</div>
				</div>
...
layui.config({
    base : "../js/"
		...
		if("${isEdit}"=='false'){
			common.cmsLaySucMsg("距离视频教学开始，已经很近了或者正在进行，不能再修改读片会信息了。")
		}
		laydate.render({
			elem : '#startTime' //指定元素
			,type: 'datetime'
