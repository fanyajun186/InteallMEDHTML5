			...
			<form class="layui-form">
			    <div class="layui-form-item" style="margin-top: 10px">
                    ...
                    <div class="layui-input-block">
                        <input name="modelName" placeholder="模板名称" class="layui-input">
                        <input type="hidden" name="reporttype" value="${reporttype}"  class="layui-input" />
                        <input type="hidden" name="clicked_id" value="${clicked_id}"  class="layui-input" />
                    </div>
                </div> 
				<div class="layui-form-item" style="margin-top: 10px">
					<label class="layui-form-label">检查所见</label>
					<div class="layui-input-block">
						<textarea name="jianchansuojian" placeholder="检查所见" class="layui-textarea layui-input"></textarea>
					</div>
				</div> 
				<div class="layui-form-item" style="margin-top: 10px">
					<label class="layui-form-label">诊断结果</label>
					<div class="layui-input-block">
						<textarea name="zhenduanjieguo" placeholder="诊断结果" class="layui-textarea layui-input"></textarea>
					</div>
				</div>
