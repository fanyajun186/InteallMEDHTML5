...
layui.use('upload', function(){
	  ...
	  ,uploadListIns = upload.render({
	    ...
	    ,multiple: true
	    ,auto: false
	    ,exts: 'jpg|png|jpeg|pdf|txt|docx|doc|wps|xls|xlsx|ppt|pptx' //文件类型jpg、png、jpeg、pdf、txt、docx、doc、wps、xls、xlsx	    
	    ,bindAction: '#testListAction'
    	,data: {"stuuid":videoKey} //可选项。额外的参数，如：{id: 123, abc: 'xxx'}	
